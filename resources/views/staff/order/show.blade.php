                            ...
                            <div class="row mt-4">
                                <div class="col-lg-8">
                                    <div class="col-md-4 d-print-none">
                                        <form action="{{ route('staff.orders.status-update', $order->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')
        ...
        $(document).ready(function() {
            $('#print_btn').on('click', function() {
                ...
                printWindow.document.write(
                    '<link rel="stylesheet" href="{{ asset('staff/assets/modules/bootstrap/css/bootstrap.min.css') }}" type="text/css">'
                );
