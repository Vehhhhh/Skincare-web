...
@section('content')
    <section class="section">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('staff.reservation-time.update', $time->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="">
                            <option @selected($time->status === 1) value="1">Active</option> {{-- in value field put true or false for postgres, 1 or 0 for mysql --}}
