...
@section('content')
    <!--=============================
                                            BREADCRUMB START
                                        ==============================-->
    <section class="fp__breadcrumb" style="background: url({{ asset('frontend/images/cover.jpg') }});">
                    ...
                    <div class="exzoom hidden" id="exzoom">
                       <div class="exzoom_img_box fp__menu_details_images">
                            <ul class='exzoom_img_ul'>
                                <li><img class="zoom ing-fluid w-100" src="{{ asset($product->thumbnail) }}" alt="product"></li>
                                            ...
                                            <div class="fp__comment pt-0 mt_20">
                                                <div class="fp__single_comment m-0 border-0">
                                                    ...
                                                    <div class="fp__single_comm_text">
                                                        <h3> Olivia <span>25 April 2024 </span></h3>
                                                        <span class="rating">
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                ...
                                                <div class="fp__single_comment">
                                                    ...
                                                    <div class="fp__single_comm_text">
                                                        <h3>William<span>24 April 2024 </span></h3>
                                                        <span class="rating">
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                ...
                                                <div class="fp__single_comment">
                                                    ...
                                                    <div class="fp__single_comm_text">
                                                        <h3>Emily <span>23 April 2024 </span></h3>
                                                        <span class="rating">
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                ...
                                                <div class="fp__single_comment">
                                                    ...
                                                    <div class="fp__single_comm_text">
                                                        <h3>Sophia <span>22 April 2024 </span></h3>
                                                        <span class="rating">
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-xl-3 wow fadeInUp" data-wow-duration="1s">
                                <div class="fp__menu_item">
                                    <div class="fp__menu_item_img">
                                        <img src="{{ asset($relatedProduct->thumbnail) }}"
        ...
        $(document).ready(function() {
            ...
            $("#v_add_to_cart_form").on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    //xhr contain html requst object that will grab message from CartController
