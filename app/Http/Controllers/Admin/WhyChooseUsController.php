...
class WhyChooseUsController extends Controller
{
    ...
    public function updateTitle(Request $request)
    {
        ...
        SectionTitle::updateOrCreate( //this code will check if the value exists or not in the key column, if it does it will update the value of it.
            //if it doesnt exist, it will create a new data with the same key.
