...
class ReservationTimeController extends Controller
{
    ...
    {
        return $dataTable->render('staff.reservation.reservation-time.index');
    }
    ...
    {
        return view('staff.reservation.reservation-time.create');
    }
    ...
    public function store(Request $request) :RedirectResponse
    {
        ...
        return redirect()->route('staff.reservation-time.index');
    }
    /**
    ...
    public function edit(string $id) : View
    {
        ...
        return view('staff.reservation.reservation-time.edit', compact('time'));
    }
