...
class DeliveryAreaController extends Controller
{
    ...
    {
        return $dataTable->render('staff.delivery-area.index');
    }
    ...
    {
        return view('staff.delivery-area.create');
    }
    ...
    public function store(DeliveryAreaCreateRequest $request)
    {
        ...
        return to_route('staff.delivery-area.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('staff.delivery-area.edit', compact('area'));
    }
