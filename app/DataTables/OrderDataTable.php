    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $view = "<a href='" . route('staff.orders.show', $query->id) . "' class='btn btn-primary'><i class='fas fa-eye'></i></i></i></a>";
                ...
                $delete = "<a href='" . route('staff.orders.destroy', $query->id) . "' class='btn btn-danger ml-2 delete-item'><i class='fas fa-trash-alt'></i></a>";
