    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $delete = "<a href='" . route('staff.reservation.destroy', $query->id) . "' class='btn btn-danger ml-2 delete-item'><i class='fas fa-trash-alt'></i></a>";
            ...
            ->addColumn('status', function($query){
                $html = '
                    ...
                    <option '.($query->status === 'pending' ? 'selected' : '').' value="pending">Pending</option> {{-- in value field put true or false for postgres, 1 or 0 for mysql --}}
